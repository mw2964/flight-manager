...
def test_flight_creation_with_required_fields():
    flight = Flight(
...
def test_flight_optional_field_defaults():
    flight = Flight(
        flight_number="ZMY111",
        aircraft_id=3,
        origin_id=1,
...
def test_valid_flight_numbers_are_accepted(flight_number):
    flight = Flight(
...
def test_invalid_flight_number_raises_value_error(flight_number):
...
def test_scheduled_arrival_before_departure_raises_value_error():
...
def test_actual_arrival_before_departure_raises_value_error():
...
def test_same_origin_and_destination_raises_value_error():
...
def test_same_pilot_and_copilot_raises_value_error():
...
def test_flight_str_representation():
    flight = Flight(
        flight_number="ZMY123",
        aircraft_id=1,
        origin_id=1,
