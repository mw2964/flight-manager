...
class Flight:
    ...
    def __init__(
        ...
        departure_time_scheduled: Optional[datetime] = None,
        departure_time_actual: Optional[datetime] = None,
        arrival_time_scheduled: Optional[datetime] = None,
        arrival_time_actual: Optional[datetime] = None,
        status: Optional[str] = None,
    ) -> None:
        
        self.__id: Optional[int] = id
        self.__flight_number: Optional[str] = flight_number
        self.__aircraft_id: Optional[int] = aircraft_id
        self.__origin_id: Optional[int] = origin_id
        self.__destination_id: Optional[int] = destination_id
        self.__pilot_id: Optional[int] = pilot_id
        self.__copilot_id: Optional[int] = copilot_id
        self.__departure_time_scheduled: Optional[datetime] = departure_time_scheduled
        self.__departure_time_actual: Optional[datetime] = departure_time_actual
        self.__arrival_time_scheduled: Optional[datetime] = arrival_time_scheduled
        self.__arrival_time_actual: Optional[datetime] = arrival_time_actual
    ...
    @property
    def aircraft_id(self) -> Optional[int]:
        return self.__aircraft_id

    @aircraft_id.setter
    def aircraft_id(self, value: Optional[int]) -> None:
        if value is not None and value < 0:
    ...
    @origin_id.setter
    def origin_id(self, value: Optional[int]) -> None:
        if value is not None and value < 0:
