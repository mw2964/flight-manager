...
class FlightUpdateMenu:
    ...
    __MENU_NAME = "Flight update menu"
    __MENU_OPTIONS = [
        ("assign_pilot", "Assign pilot or copilot"),
        ("update_status", "Update flight status"),
        ("update_all", "Edit all flight details"),
        ("add_actual_times", "Add actual departure and arrival times"),
        ...
        while True:
            ...
            if __choose_menu == "assign_pilot":
                ...
                if not self.__update_all_option():
                    print("\nAction cancelled.\n")
                    continue
            elif __choose_menu == "add_actual_times":
                if not self.__add_actual_times_option():
                    print("\nUpdate cancelled.\n")
                    continue
    ...
    def __assign_pilot_option(self):
        pass

    def __update_status_option(self):
        pass

    def __update_all_option(self):
    ...
    def __add_actual_times_option(self):
        pass
