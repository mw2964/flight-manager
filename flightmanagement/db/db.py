    ...
    with transaction(conn):
        ...
        conn.execute("""
            ...
            VALUES                                          
                ...
                (6, 1, 4, 1, 45, 10, 9, 'ZMY002', '2025-12-02', '03:15', '2025-12-02', '07:10', '2025-12-02', '03:20', '2025-12-02', '07:05', 'Arrived'),
                (6, 4, 1, 48, 4, 10, 9, 'ZMY013', '2025-12-02', '07:50', '2025-12-02', '11:40', '2025-12-02', '07:55', '2025-12-02', '11:45', 'Arrived'),
                (2, 1, 9, 6, 115, 9, 10, 'ZMY005', '2025-12-06', '20:20', '2025-12-06', '22:00', '2025-12-06', '20:30', '2025-12-06', '22:05', 'Arrived'),
                (2, 9, 1, 116, 11, 10, 9, 'ZMY016', '2025-12-06', '22:40', '2025-12-07', '04:15', '2025-12-06', '22:45', '2025-12-07', '04:20', 'Arrived'),
                (3, 1, 10, 6, 125, 10, 5, 'ZMY006', '2025-12-10', '08:40', '2025-12-10', '14:30', '2025-12-10', '08:45', '2025-12-10', '14:25', 'Arrived'),
                (3, 10, 1, 132, 10, 5, 10, 'ZMY017', '2025-12-10', '15:10', '2025-12-10', '17:10', '2025-12-10', '15:15', '2025-12-10', '17:20', 'Arrived'),
                (4, 1, 7, 12, 88, 7, 9, 'ZMY004', '2025-12-14', '19:05', '2025-12-15', '01:00', '2025-12-14', '19:15', '2025-12-15', '01:10', 'Arrived'),
                (10, 7, 1, 72, 9, 2, 8, 'ZMY015', '2025-12-15', '08:50', '2025-12-15', '11:00', '2025-12-15', '08:55', '2025-12-15', '11:05', 'Arrived'),
                (5, 1, 12, 9, 125, 3, 9, 'ZMY008', '2025-12-18', '05:05', '2025-12-18', '09:00', '2025-12-18', '05:10', '2025-12-18', '08:55', 'Arrived'),
                (5, 12, 1, 165, 10, 9, 3, 'ZMY019', '2025-12-18', '09:40', '2025-12-18', '12:20', '2025-12-18', '09:55', '2025-12-18', '12:25', 'Arrived'),
                (7, 1, 15, 9, 45, 7, 2, 'ZMY011', '2026-01-03', '03:45', '2026-01-03', '04:45', '2026-01-03', '03:50', '2026-01-03', '04:40', 'Arrived'),
                (7, 15, 1, 232, 9, 2, 7, 'ZMY022', '2026-01-03', '05:25', '2026-01-03', '10:25', '2026-01-03', '05:30', '2026-01-03', '10:30', 'Arrived'),
                (1, 1, 2, 7, 10, 5, 10, 'ZMY001', '2026-01-06', '08:00', '2026-01-06', '10:25', '2026-01-06', '08:05', '2026-01-06', '10:20', 'Arrived'),
                (1, 2, 1, 11, 7, 10, 5, 'ZMY012', '2026-01-06', '11:05', '2026-01-06', '14:10', '2026-01-06', '11:10', '2026-01-06', '14:15', 'Arrived'),
                (8, 1, 5, 9, 115, 2, 8, 'ZMY003', '2026-01-10', '16:00', '2026-01-10', '20:00', '2026-01-10', '16:05', '2026-01-10', '20:10', 'Arrived'),
                (8, 5, 1, 10, 9, 8, 2, 'ZMY014', '2026-01-10', '20:40', '2026-01-10', '23:50', '2026-01-10', '20:45', '2026-01-10', '23:55', 'Arrived'),
                (6, 1, 11, 4, 45, 3, 7, 'ZMY007', '2026-01-14', '19:00', '2026-01-14', '20:30', '2026-01-14', '19:05', '2026-01-14', '20:25', 'Arrived'),
                (6, 11, 1, 4, 9, 3, 7, 'ZMY018', '2026-01-14', '21:10', '2026-01-15', '02:05', '2026-01-14', '21:15', '2026-01-15', '02:10', 'Arrived'),
                (4, 1, 13, 12, 125, 3, 4, 'ZMY009', '2026-01-20', '15:35', '2026-01-20', '18:25', '2026-01-20', '15:50', '2026-01-20', '18:20', 'Arrived'),
                (4, 13, 1, 10, 12, 4, 3, 'ZMY020', '2026-01-20', '19:05', '2026-01-20', '22:30', '2026-01-20', '19:10', '2026-01-20', '22:35', 'Arrived')
        """)
