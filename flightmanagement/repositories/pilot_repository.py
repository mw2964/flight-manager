...
class PilotRepository(BaseRepository):
    ...
    def get_leave_bookings_by_staff_member_id(self, staff_member_id: int) -> list:
        rows = self._execute_fetchall(
            """
            SELECT *
            FROM leave_bookings
    ...
    def get_leave_record_by_staff_member_id_and_date(self, staff_member_id: int, leave_date: date) -> list:
    ...
    def get_flight_log_record_by_staff_member_id_and_date(self, staff_member_id: int, effective_date: date) -> list:
        row = self._execute_fetchone(
            """
            SELECT *
            FROM flight_time_logs
